...
const CategoriesManagement = () => {
  ...
  const fetchCategories = async () => {
    try {
      ...
      const response = await axios.get(
        "https://food-delivery-backend-gray.vercel.app/v1/category/all",
        {
  ...
  const handleAddCategory = async () => {
    try {
      ...
      await axios.post(
        "https://food-delivery-backend-gray.vercel.app/v1/category/create",
        formDataObj,
        {
          withCredentials: true,
          headers: {
  ...
  const handleUpdateCategory = async () => {
    try {
      ...
      await axios.put(
        `https://food-delivery-backend-gray.vercel.app/v1/category/${selectedCategory._id}`,
        formDataObj,
        {
          withCredentials: true,
          headers: {
