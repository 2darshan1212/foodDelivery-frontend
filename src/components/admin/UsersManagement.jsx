...
const UsersManagement = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await axios.get(
        `https://food-delivery-backend-gray.vercel.app/api/api/v1/user/admin/users?${params.toString()}`,
        {
  ...
  const handleUpdateUser = async () => {
    try {
      ...
      const response = await axios.put(
        `https://food-delivery-backend-gray.vercel.app/api/api/v1/user/admin/${selectedUser._id}`,
        {
  ...
  const handleToggleAdmin = async () => {
    try {
      ...
      const response = await axios.put(
        `https://food-delivery-backend-gray.vercel.app/api/api/v1/user/admin/${selectedUser._id}/${endpoint}`,
        {},
        {
          withCredentials: true,
        }
