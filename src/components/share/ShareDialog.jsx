  ...
  const fetchUsers = async () => {
    try {
      ...
      const res = await axios.get(
        "https://food-delivery-backend-gray.vercel.app/api/api/v1/user/suggested-users",
  ...
  const handleShareWithUsers = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://food-delivery-backend-gray.vercel.app/api/api/v1/share/create",
        {
          postId: post._id,
          sharedWith: "specific",
  ...
  const handleExternalShare = async (platform) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        try {
          await axios.post(
            "https://food-delivery-backend-gray.vercel.app/api/api/v1/analytics/record",
            {
              type: "share",
              postId: post._id,
              platform,
