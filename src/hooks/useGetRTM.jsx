...
const useGetRTM = () => {
  ...
  useEffect(() => {
    ...
    const handleNewMessage = (newMessage) => {
      ...
      if (
        ...
        fetch(
          `https://food-delivery-backend-gray.vercel.app/api/api/v1/message/read/${newMessage.senderId}`,
          {
            method: "PUT",
            credentials: "include",
          }
  ...
  useEffect(() => {
    ...
    fetch(
      `https://food-delivery-backend-gray.vercel.app/api/api/v1/message/read/${selectedUser._id}`,
      {
        method: "PUT",
        credentials: "include",
      }
