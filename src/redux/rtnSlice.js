  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        "https://food-delivery-backend-gray.vercel.app/api/api/v1/notifications",
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.patch(
        "https://food-delivery-backend-gray.vercel.app/api/api/v1/notifications/mark-all-read",
        {},
        { withCredentials: true }
      );
...
export const markNotificationRead = createAsyncThunk(
  ...
  async (notificationId, { rejectWithValue }) => {
    try {
      const response = await axios.patch(
        `https://food-delivery-backend-gray.vercel.app/api/api/v1/notifications/mark-read/${notificationId}`,
        {},
        { withCredentials: true }
      );
